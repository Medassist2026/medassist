                ...
                {conversations.map(conv => (
                  <div
                    ...
                    className={`p-4 border-b border-gray-100 cursor-pointer hover:bg-gray-50 ${
                      selectedDoctor?.id === conv.doctor.id ? 'bg-primary-50' : ''
                    }`}
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-primary-600">{formatSpecialty(conv.doctor.specialty)}</p>
              ...
              <>
                ...
                <div className="p-4 border-b border-gray-200 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-primary-600">{formatSpecialty(selectedDoctor.specialty)}</p>
                  </div>
                </div>
                      ...
                      >
                        ...
                        >
                          ...
                          <p className={`text-xs mt-1 ${
                            msg.sender_type === 'patient' ? 'text-primary-200' : 'text-gray-500'
                          }`}>
