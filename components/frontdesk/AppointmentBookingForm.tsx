...
export default function AppointmentBookingForm() {
  ...
  const [step, setStep] = useState(1) // 1: Patient, 2: Doctor & Date, 3: Time, 4: Confirm
      ...
      <div className="p-6 space-y-6">
        ...
        {step === 1 && (
          <div className="space-y-4">
            <h3 className="font-semibold text-lg text-gray-900">Select Patient</h3>
            ...
            {selectedPatient && (
              <div className="p-4 bg-primary-50 border border-primary-200 rounded-lg flex justify-between items-center">
                <div>
        ...
        {step === 2 && (
          <div className="space-y-4">
            <h3 className="font-semibold text-lg text-gray-900">Select Doctor & Date</h3>
        ...
        {step === 4 && (
          <div className="space-y-4">
            <h3 className="font-semibold text-lg text-gray-900">Confirm Appointment</h3>
