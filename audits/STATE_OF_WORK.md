...
11. Task 10 — `auto-renew-on-visit-gpid-lookup` admin scope addition — **✅ DONE 2026-05-08** (admin.ts allow-list extended; runtime `console.warn` eliminated for the active-share check-in path; broader Task 16 reconciliation still queued)
