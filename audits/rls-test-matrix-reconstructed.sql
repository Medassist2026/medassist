...
-- Run target:  staging (mtmdotixlhwksyoordbl), latest records at run_no = 2.0
--
-- WHAT THIS FILE IS
-- -----------------
...
DELETE FROM public._rls_test_results WHERE run_no = 2.0;
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'clinics'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  FOR rec IN SELECT * FROM (VALUES
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'clinical_notes'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'conversations'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  FOR rec IN SELECT * FROM (VALUES
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'doctor_availability'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  FOR rec IN SELECT * FROM (VALUES
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'doctors'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  FOR rec IN SELECT * FROM (VALUES
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'global_patients'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  FOR rec IN SELECT * FROM (VALUES
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'messages'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  FOR rec IN SELECT * FROM (VALUES
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'notifications'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  FOR rec IN SELECT * FROM (VALUES
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'patient_clinic_records'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  FOR rec IN SELECT * FROM (VALUES
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'patient_data_shares'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  FOR rec IN SELECT * FROM (VALUES
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'patient_privacy_codes'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  FOR rec IN SELECT * FROM (VALUES
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'payments'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  FOR rec IN SELECT * FROM (VALUES
    ('S1', s_doctor_a,       'doctor_a clinic_a',                                 'SUCCESS', 1, 'READ',
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'privacy_code_attempts'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  FOR rec IN SELECT * FROM (VALUES
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'privacy_code_sms_tokens'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  FOR rec IN SELECT * FROM (VALUES
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'users'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  FOR rec IN SELECT * FROM (VALUES
    ('S1', s_doctor_a,       'doctor_a sees self',                                                'SUCCESS', 1, 'READ',
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'audit_events'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  FOR rec IN SELECT * FROM (VALUES
    ('S6',  s_patient_y_user,
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'imaging_orders'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  SELECT pcr.id INTO s_pcr_x_at_a FROM public.patient_clinic_records pcr
   WHERE pcr.global_patient_id = s_patient_x_gp AND pcr.clinic_id = s_clinic_a;
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'lab_orders'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  SELECT pcr.id INTO s_pcr_x_at_a FROM public.patient_clinic_records pcr
   WHERE pcr.global_patient_id = s_patient_x_gp AND pcr.clinic_id = s_clinic_a;
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'lab_results'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  SELECT pcr.id INTO s_pcr_x_at_a FROM public.patient_clinic_records pcr
   WHERE pcr.global_patient_id = s_patient_x_gp AND pcr.clinic_id = s_clinic_a;
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'prescription_items'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  SELECT pcr.id INTO s_pcr_x_at_a FROM public.patient_clinic_records pcr
   WHERE pcr.global_patient_id = s_patient_x_gp AND pcr.clinic_id = s_clinic_a;
...
DECLARE
  ...
  rec RECORD; v_count INT; v_pass BOOLEAN; v_caught BOOLEAN; v_notes TEXT;
  v_table TEXT := 'vital_signs'; v_run NUMERIC := 2.0;
  v_src TEXT := 'audits/rls-test-matrix-reconstructed.sql';
BEGIN
  SELECT pcr.id INTO s_pcr_x_at_a FROM public.patient_clinic_records pcr
   WHERE pcr.global_patient_id = s_patient_x_gp AND pcr.clinic_id = s_clinic_a;
